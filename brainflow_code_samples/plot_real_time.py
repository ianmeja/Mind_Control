...
class Graph:
    ...
    def _init_psd(self):
        ...
        self.psd_plot.setLabel('left', 'Power (uV)^2/Hz')
    ...
    def _init_band_plot(self):
        ...
        string_labels = ['Delta', 'Theta', 'Alpha', 'Beta', 'Gamma']
        self.band_plot.getAxis('bottom').setTicks([[(i + 1, string_labels[i]) for i in range(len(string_labels))]])
